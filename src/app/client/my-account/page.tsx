...
export default function MyAccount() {
  ...
  return (
    <div className="p-8 min-h-screen bg-gradient-to-br from-[#FBF0DA] to-[#F7F7F7]">
      ...
      <p className="text-[#271F18] font-serif mb-8 text-base">Manage your account details here. Update your personal information, email address, or password to keep your profile up-to-date.</p>
