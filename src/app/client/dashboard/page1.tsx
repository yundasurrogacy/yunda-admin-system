  ...
  return (
    <div className="space-y-8 max-w-5xl mx-auto">
      ...
      <div className="grid grid-cols-3 gap-6 mb-8">
        <div className="p-6 rounded-xl bg-white text-sage-800 font-medium shadow">
          <h2 className="text-lg font-medium mb-2">Intended Parent Journeys 总数</h2>
          <div className="text-3xl font-bold mb-2">{journeySummary.total}</div>
        </div>
        <div className="p-6 rounded-xl bg-white text-sage-800 font-medium shadow">
          <h2 className="text-lg font-medium mb-2">已完成</h2>
          <div className="text-3xl font-bold mb-2">{journeySummary.finished}</div>
        </div>
        <div className="p-6 rounded-xl bg-white text-sage-800 font-medium shadow">
          <h2 className="text-lg font-medium mb-2">进行中</h2>
          <div className="text-3xl font-bold mb-2">{journeySummary.pending}</div>
        </div>
      </div>
