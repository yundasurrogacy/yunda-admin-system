...
/** 格式化单条分娩记录为一行文本（GC: delivery_history 或 非GC: pregnancy_histories） */
...
/** 固定列导出：一行一个孕妈，分娩记录预设 10 列，附加信息列预留空 */
function buildSurrogateDetailFixedRow(
...
export default function SurrogateApplicationDetailPage() {
  ...
  const fixedExportData = useMemo(() => {
    ...
    return buildSurrogateDetailFixedRow(application, parsedData, t)
  }, [application, parsedData, t, i18n.language])
