...
export default function SurrogateProfileDetailPage() {
  ...
  // 只读/编辑数据源
  const data = editMode ? editData : surrogate
  const ci = data?.contact_information || {}
  const ph = data?.pregnancy_and_health || {}
  const ay = data?.about_you || {}
  const interview = data?.gestational_surrogacy_interview || {}

  // 通用空值显示（国际化）
  const displayValue = (val: any, emptyText = t('none', '无')) => {
  ...
  return (
      <div className="min-h-screen bg-main-bg space-y-6 animate-fade-in px-4 lg:px-12 text-sage-800 font-medium">
        ...
        <div className="w-full flex flex-col items-center mb-6">
          <h3 className="text-lg font-semibold text-sage-800 mb-3">{t('uploadPhotos')}</h3>
          {editMode ? (
            <>
            ...
            <div className="flex items-start justify-between mb-6">
              <div className="flex items-center gap-4">
                ...
                <div>
                  ...
                  <p className="text-sage-500 font-normal">ID: #{data.id} • {editMode ? (
              ...
              <Badge variant="outline" className="px-3 py-1 bg-green-100 text-green-800 border-green-200 font-medium">
              ...
              <div className="space-y-4">
                ...
                <div className="mt-6">
                  ...
                  {Array.isArray(ph?.pregnancy_histories) && ph.pregnancy_histories.length > 0 ? (
                          ...
                          <div className="grid grid-cols-2 md:grid-cols-4 gap-4 text-sm">
                            ...
                            <div>
                              ...
                              {editMode ? (
                                ...
                                <div className="text-sage-800">{displayValue(history.birth_weight)} kg</div>
                              )}
                            </div>
                            <div>
                    ...
                    <p className="text-sage-500 text-sm italic">{t('none', '无')}</p>
                  )}
                </div>
              </div>
            </CardContent>
              ...
              <div className="space-y-3">
                <div>
                  ...
                  {editMode ? (
                    ...
                    <div className="p-2 bg-sage-50 rounded text-sage-800 text-sm mt-1">{displayValue(interview?.emotional_support, t('none', '无'))}</div>
                  )}
                </div>
                <div>
                  ...
                  {editMode ? (
                    ...
                    <div className="p-2 bg-sage-50 rounded text-sage-800 text-sm mt-1">{displayValue(interview?.languages_spoken, t('none', '无'))}</div>
                  )}
                </div>
                <div>
                  ...
                  {editMode ? (
                    ...
                    <div className="p-2 bg-sage-50 rounded text-sage-800 text-sm mt-1">{displayValue(interview?.motivation, t('none', '无'))}</div>
                  )}
                </div>
              </div>
              <div className="space-y-3">
                <div>
                  ...
                  {editMode ? (
                    ...
                    <div className="p-2 bg-sage-50 rounded text-sage-800 text-sm mt-1 whitespace-pre-wrap">{displayValue(interview?.self_introduction, t('none', '无'))}</div>
                  )}
                </div>
                <div>
                  ...
                  {editMode ? (
                    ...
                    <div className="p-2 bg-sage-50 rounded text-sage-800 text-sm mt-1">{displayValue(interview?.contact_preference, t('none', '无'))}</div>
                  )}
                </div>
